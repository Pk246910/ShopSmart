...
class MeeshoProvider(BaseProvider):
    """Meesho provider — uses ProductExtractor for extraction."""

    def __init__(self):
        super().__init__()
        self.platform_name = "Meesho"
    ...
    def get_product_details(self, product_url: str) -> Optional[ProductData]:
        try:
            ...
            raw = extractor.extract(product_url, "Meesho")
            ...
            logger.warning("Meesho extraction failed for %s: %s", product_url, e)
            return None

...
class MyntraProvider(BaseProvider):
    """Myntra provider — uses ProductExtractor for extraction."""
    ...
    def get_product_details(self, product_url: str) -> Optional[ProductData]:
        try:
            ...
            raw = extractor.extract(product_url, "Myntra")
            ...
            logger.warning("Myntra extraction failed for %s: %s", product_url, e)
            return None

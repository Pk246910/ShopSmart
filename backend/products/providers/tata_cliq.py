...
class TataCLiQProvider(BaseProvider):
    """Tata CLiQ provider — uses ProductExtractor for extraction."""

    def __init__(self):
        super().__init__()
        self.platform_name = "Tata CLiQ"
    ...
    def get_product_details(self, product_url: str) -> Optional[ProductData]:
        try:
            ...
            raw = extractor.extract(product_url, "Tata CLiQ")
            ...
            logger.warning("Tata CLiQ extraction failed for %s: %s", product_url, e)
            return None

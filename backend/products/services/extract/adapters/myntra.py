...
_CONFIG = {
    "selectors": {
        ...
        "price": ["span.pdp-price-strong", "span.price-per-piece"],
        "mrp": ["span.pdp-mrp"],
        "rating": ["div.index-overallRating"],
        "reviews": ["div.index-ratingsCount"],
        "image": ["img.picture-picture", "img.jCqzTN"],
        "brand": ["h1.pdp-name"],
    },
    "id_patterns": [r"/(\d{6,})(?:\?|/|$)"],
...
class MyntraExtractor(BaseProductExtractor):
    name = "Myntra"
    domains = ("myntra.com",)

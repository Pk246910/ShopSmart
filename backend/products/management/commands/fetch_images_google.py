"""Fetch real product images using Google Custom Search API + query template.
...
Without keys it falls back to template query + Bing scraping.
"""
import os
import re
import time
...
def gemini_query(product):
    """Build an image-search query for this product.

    (Formerly drafted by Gemini; now a plain template since the
    Multi-AI system was removed. Behavior is unchanged.)
    """
...
class Command(BaseCommand):
    help = 'Fetch real product images via Google Custom Search + template queries'

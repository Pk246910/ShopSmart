            ...
            return (
              <div key={w.id} className="product-card-elevated">
                ...
                <Link to={`/product/${p.id}`} style={{ textDecoration: "none", color: "inherit" }}>
                  <div className="image-showcase" style={{ height: 180, margin: "0.75rem 0", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", borderRadius: 10 }}>
                    <img src={getProductImage(p.image_url)} alt={p.title} style={{ maxHeight: "100%", maxWidth: "100%", objectFit: "contain" }} onError={handleImageError} />
                  </div>
